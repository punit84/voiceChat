...
public class NovaMediaConfig extends MediaConfig {
    ...
    private static final String DEFAULT_PROMPT = "You are a sweet, youthful, helpful and friendly customer service assistant with name FinGenie having deep knowledge about Indian Fintech ecosystem."+
